(function($,window,document,undefined){"use strict";var pluginName="swyftCallback",form_obj_prefix='sc_',form_fields_prefix=form_obj_prefix+'fld_',input_all_mask='input, select, textarea',defaults={api:{url:'test',custom:[{name:'api_key',value:''},],param:{success:{name:'result',value:'success'},message:'',},},data:{form_method:"post",send_headers:!0,custom_button_data:"",custom_popup_data:"",},appearance:{custom_button_class:"",custom_popup_class:"",show_check_all_agreements:!0,overflown_overlay:!0,},status:{popup_hidden:!0,popup_body_collapsed:!1,button_disabled:!1,ajax_processing:!1,response_from_api_visible:!0,},text_vars:{popup_title:"Contact form",popup_body:"Leave us your phone number. We'll call you back.",send_button_text:"Send",wrong_input_text:"Wrong input",status_success:"Form sent successfuly",status_sending:"Sending form...",status_error:"Server encountered an error",},novalidate:!0,input:{prefix:form_fields_prefix,fields:[{obj:null,name:'phone',field_name:form_fields_prefix+'telephone',label:'Phone number',type:'tel',data_field_type:'phone',placeholder:'000-000-000',max_length:20,required:!0},],agreements:[{obj:null,field_name:form_fields_prefix+'agreement',type:'checkbox',short:'Lorem',long:'Ipsum',readmore:'More',required:!0,checked:!0,}],check_all_agreements:{obj:null,short:'Check all agreements',},regex_table:{'phone':/(\(?(\+|00)?48\)?([ -]?))?(\d{3}[ -]?\d{3}[ -]?\d{3})|([ -]?\d{2}[ -]?\d{3}[ -]?\d{2}[ -]?\d{2})/,'email':/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,'name':/^[a-zA-Z\u00E0\u00E1\u00E2\u00E4\u00E3\u00E5\u0105\u010D\u0107\u0119\u00E8\u00E9\u00EA\u00EB\u0117\u012F\u00EC\u00ED\u00EE\u00EF\u0142\u0144\u00F2\u00F3\u00F4\u00F6\u00F5\u00F8\u00F9\u00FA\u00FB\u00FC\u0173\u016B\u00FF\u00FD\u017C\u017A\u00F1\u00E7\u010D\u015B\u0161\u015B\u017E\u00C0\u00C1\u00C2\u00C4\u00C3\u00C5\u0104\u0106\u010C\u0116\u0118\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u012E\u0141\u0143\u00D2\u00D3\u00D4\u00D6\u00D5\u00D8\u00D9\u00DA\u00DB\u00DC\u0172\u016A\u0178\u00DD\u017B\u0179\u00D1\u00DF\u00C7\u0152\u00C6\u010C\u015A\u0160\u015A\u017D\u2202\u00F0 ,.'-]+$/,},data_dictionary:{}},callbacks:{onShow:null,onHide:null,onSend:{success:{function:null,this:this,parameters:null,},error:{function:null,this:this,parameters:null,}}}};function Plugin(element,options){this.element=element;this.settings=$.extend(!0,{},defaults,options);this._defaults=defaults;this._name=pluginName;this.setDefaultVars();this.html=$('html');this.button={obj:null};this.popup={obj:null,form:null,body:null,footer:null};this.init()}
    $.extend(Plugin.prototype,{init:function(){this.initPopup();this.initButton()},setDefaultVars:function(){if(this.settings.input.fields){var template=defaults.input.fields[0];for(var i=0;i<this.settings.input.fields.length;i++){this.settings.input.fields[i]=$.extend({},template,this.settings.input.fields[i])}}
            ...
            if(this.settings.status.popup_hidden){this.ShowPopup(options)}else{this.HidePopup(options)}},ShowPopup:function(options){if(this.settings.status.button_disabled){return}
            var objThis=this;var defaults={fade_duration:300,};var settings=$.extend({},defaults,options);if(objThis.settings.appearance.overflown_overlay){this.html.addClass('overflown')}
            this.popup.obj.fadeIn(settings.fade_duration);this.popup.form.find(input_all_mask).first().focus();this.button.obj.addClass('hide');this.settings.status.popup_hidden=!1;if(objThis.settings.callbacks.onShow.function&&$.isFunction(objThis.settings.callbacks.onShow.function)){objThis.settings.callbacks.onShow.function.apply(objThis.settings.callbacks.onShow.this,[$.extend(!0,{},this,objThis.settings.callbacks.onShow.parameters)])}},HidePopup:function(options){if(this.settings.status.button_disabled){return}
            var objThis=this;var defaults={fade_duration:300,};var settings=$.extend({},defaults,options);if(objThis.settings.appearance.overflown_overlay){this.html.removeClass('overflown')}
            this.popup.obj.fadeOut(settings.fade_duration,function(){objThis.ResetInput({clear_status_only:!0});objThis.StatusClear()});this.button.obj.removeClass('hide');this.settings.status.popup_hidden=!0;if(objThis.settings.callbacks.onHide.function&&$.isFunction(objThis.settings.callbacks.onHide.function)){objThis.settings.callbacks.onHide.function.apply(objThis.settings.callbacks.onHide.this,[$.extend(!0,{},this,objThis.settings.callbacks.onHide.parameters)])}},CollapsePopupBodyToggle:function(options){var objThis=this;var defaults={slide_duration:300,action:'toggle',};var settings=$.extend({},defaults,options);switch(settings.action){case 'toggle':if(this.settings.status.popup_body_collapsed){this.popup.body.slideDown(settings.slide_duration);this.settings.status.popup_body_collapsed=!1}else{this.popup.body.slideUp(settings.slide_duration);this.settings.status.popup_body_collapsed=!0}
            break;case 'show':this.popup.body.slideDown(settings.slide_duration);this.settings.status.popup_body_collapsed=!1;break;case 'hide':this.popup.body.slideUp(settings.slide_duration);this.settings.status.popup_body_collapsed=!0;break;default:break}},DisableButton:function(input){this.settings.status.button_disabled=!!input},ValidateField:function(_field,options){var defaults={};var settings=$.extend({},defaults,options);var field=_field;var $this=field.obj;var is_valid=!0;if(field.type==='checkbox'){if(field.required===!0){if(!$this.prop('checked')){is_valid=!1}}}
