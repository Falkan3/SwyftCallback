(function($,window,document,undefined){"use strict";var pluginName="swyftCallback",form_obj_prefix='sc_',form_fields_prefix=form_obj_prefix+'fld_',input_all_mask='input, select, textarea',defaults={api:{url:'test',custom:[{name:'api_key',value:''},],param:{success:{name:'result',value:'success'},message:'',},},data:{form_method:"post",send_headers:!0,custom_button_data:"",custom_popup_data:"",utm_params_dictionary:['utm_source','utm_medium','utm_campaign','utm_term','utm_content','keypartner'],},appearance:{custom_button_class:"",custom_popup_class:"",show_check_all_agreements:!0,overflown_overlay:!0,},status:{popup_hidden:!0,popup_body_collapsed:!1,button_disabled:!1,ajax_processing:!1,response_from_api_visible:!0,},text_vars:{popup_title:"Contact form",popup_body:"Leave us your phone number. We'll call you back.",send_button_text:"Send",wrong_input_text:"Wrong input",status_success:"Form sent successfuly",status_sending:"Sending form...",status_error:"Server encountered an error",},novalidate:!0,input:{prefix:form_fields_prefix,fields:[{obj:null,name:'phone',field_name:form_fields_prefix+'telephone',label:'Phone number',type:'tel',data_field_type:'phone',placeholder:'000-000-000',max_length:20,required:!0},],agreements:[{obj:null,field_name:form_fields_prefix+'agreement',type:'checkbox',short:'Lorem',long:'Ipsum',readmore:'More',required:!0,checked:!0,}],check_all_agreements:{obj:null,short:'Check all agreements',},regex_table:{'phone':/(\(?(\+|00)?48\)?([ -]?))?(\d{3}[ -]?\d{3}[ -]?\d{3})|([ -]?\d{2}[ -]?\d{3}[ -]?\d{2}[ -]?\d{2})/,'email':/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,'name':/^[a-zA-Z\u00E0\u00E1\u00E2\u00E4\u00E3\u00E5\u0105\u010D\u0107\u0119\u00E8\u00E9\u00EA\u00EB\u0117\u012F\u00EC\u00ED\u00EE\u00EF\u0142\u0144\u00F2\u00F3\u00F4\u00F6\u00F5\u00F8\u00F9\u00FA\u00FB\u00FC\u0173\u016B\u00FF\u00FD\u017C\u017A\u00F1\u00E7\u010D\u015B\u0161\u015B\u017E\u00C0\u00C1\u00C2\u00C4\u00C3\u00C5\u0104\u0106\u010C\u0116\u0118\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u012E\u0141\u0143\u00D2\u00D3\u00D4\u00D6\u00D5\u00D8\u00D9\u00DA\u00DB\u00DC\u0172\u016A\u0178\u00DD\u017B\u0179\u00D1\u00DF\u00C7\u0152\u00C6\u010C\u015A\u0160\u015A\u017D\u2202\u00F0 ,.'-]+$/,},data_dictionary:{}},callbacks:{onShow:null,onHide:null,onSend:{success:{function:null,this:this,parameters:null,},error:{function:null,this:this,parameters:null,}}}};function Plugin(element,options){this.element=element;this.settings=$.extend(!0,{},defaults,options);this._defaults=defaults;this._name=pluginName;this.setDefaultVars();this.html=$('html');this.button={obj:null};this.popup={obj:null,form:null,body:null,footer:null};this.init()}
    $.extend(Plugin.prototype,{init:function(){this.initPopup();this.initButton()},setDefaultVars:function(){if(this.settings.input.fields){var template=defaults.input.fields[0];for(var i=0;i<this.settings.input.fields.length;i++){this.settings.input.fields[i]=$.extend({},template,this.settings.input.fields[i])}}
            ...
            return output},initButton:function(){var objThis=this;var classes=this.formatClasses(this.settings.appearance.custom_button_class);var data=this.formatData(this.settings.data.custom_button_data);var $buttonBody=$('<div class="'+form_obj_prefix+'tg_btn'+classes+'" '+data+'>\n'+'    <div class="'+form_obj_prefix+'round_container">\n'+'        <div class="'+form_obj_prefix+'icon">'+'           <a href="#"></a>\n'+'        </div>\n'+'    </div>\n'+'    <div class="sc_ripple"></div>\n'+'</div>');objThis.button.obj=$buttonBody.appendTo($(objThis.element));objThis.button.obj.find('a').on('click',function(e){e.preventDefault();objThis.TogglePopup()})},initPopup_generate_fields:function(popupBody){var objThis=this;var fields='';var dynamic_attributes=[];if(objThis.settings.input.fields){var fields_section=popupBody.find('.'+form_obj_prefix+'fields_section');for(var i=0;i<objThis.settings.input.fields.length;i++){var field=objThis.settings.input.fields[i];dynamic_attributes=[{name:'input',attributes:[{key:'id',value:field.field_name},{key:'name',value:field.field_name},{key:'type',value:field.type},{key:'data-field-type',value:field.data_field_type},{key:'placeholder',value:field.placeholder},{key:'value',value:field.value},{key:'maxlength',value:field.max_length},{key:'required',value:field.required},],formatted:''},];dynamic_attributes=objThis.formatDynamicAttributes(dynamic_attributes);var output='<div class="'+form_obj_prefix+'division">\n'+'               <div class="input">\n'+'                   <label for="'+field.field_name+'">'+field.label+'</label>\n'+'                   <input '+dynamic_attributes[0].formatted+'/>\n'+'               </div>\n'+'             </div>\n';fields+=output;var $obj=$(output).appendTo(fields_section);objThis.settings.input.fields[i].obj=$obj.find(input_all_mask).first()}}
            return fields},initPopup_generate_popup_agreements:function(popupBody){var objThis=this;var agreements_section=popupBody.find('.'+form_obj_prefix+'agreements_section');var agreements='';var output='';var $obj=null;if(objThis.settings.input.agreements){if(objThis.settings.appearance.show_check_all_agreements&&objThis.settings.input.agreements.length>0){output='<div class="'+form_obj_prefix+'division">\n'+'               <div class="input">\n'+'                   <div class="'+form_obj_prefix+'checkbox_container">\n'+'                       <input id="'+form_fields_prefix+'agreement_all" name="'+form_fields_prefix+'agreement_all" type="checkbox" data-field-type="checkbox" />\n'+'                       <span class="checkmark"></span>\n'+'                   </div>\n'+'\n'+'                   <label for="'+form_fields_prefix+'agreement_all">'+objThis.settings.input.check_all_agreements.short+'</label>\n'+'               </div>\n'+'          </div>';$obj=$(output).appendTo(agreements_section);objThis.settings.input.check_all_agreements.obj=$obj.find(input_all_mask).first()}
            for(var i=0;i<objThis.settings.input.agreements.length;i++){var agreement=objThis.settings.input.agreements[i];var dynamic_attributes=[];dynamic_attributes=[{name:agreement.field_name,attributes:[{key:'id',value:agreement.field_name},{key:'name',value:agreement.field_name},{key:'type',value:'checkbox'},{key:'value',value:'true'},{key:'data-field-type',value:'checkbox'},],formatted:''},];if(agreement.checked){dynamic_attributes[0].attributes.push({key:'checked',value:'checked'})}
                dynamic_attributes=objThis.formatDynamicAttributes(dynamic_attributes);output='<div class="'+form_obj_prefix+'division">'+'           <div class="input">'+'               <div class="'+form_obj_prefix+'checkbox_container">\n'+'                   <input '+dynamic_attributes[0].formatted+' />\n'+'                   <span class="checkmark"></span>\n'+'               </div>\n'+'\n'+'               <label for="'+agreement.field_name+'">'+agreement.short+' <span class="'+form_obj_prefix+'readmore">'+agreement.readmore+' </span></label>\n'+'               <div class="'+form_obj_prefix+'readmore_body" style="display: none;">\n'+'                   <span>\n'+'                   '+agreement.long+'                   </span>\n'+'               </div>'+'           </div>'+'         </div>';agreements+=output;$obj=$(output).appendTo(agreements_section);objThis.settings.input.agreements[i].obj=$obj.find(input_all_mask).first()}}
            return agreements},initPopup_generate_popup_body:function(){var objThis=this;var dynamic_attributes=[];var classes=objThis.formatClasses(objThis.settings.appearance.custom_popup_class);dynamic_attributes=[{name:'form',attributes:[{key:'action',value:objThis.settings.api.url},{key:'method',value:objThis.settings.data.form_method},{key:'novalidate',value:objThis.settings.novalidate},],formatted:''},];dynamic_attributes=objThis.formatDynamicAttributes(dynamic_attributes);var $popupBody='<div class="'+form_obj_prefix+'overlay" style="display: none;">\n'+'    <div class="'+form_obj_prefix+'popup_container">\n'+'        <div class="'+form_obj_prefix+'popup'+classes+'">\n'+'            <div class="'+form_obj_prefix+'btn_close"></div>\n'+'            <div class="'+form_obj_prefix+'title_section">\n'+'                <p>'+objThis.settings.text_vars.popup_title+'</p>\n'+'            </div>\n'+'\n'+'            <div class="'+form_obj_prefix+'body_section">\n'+'                <p>'+objThis.settings.text_vars.popup_body+'</p>\n'+'                <form '+dynamic_attributes[0].formatted+'>\n'+'                    <div class="container-fluid no-padding">\n'+'                        <div class="row">\n'+'                            <div class="col-xs-12 '+form_obj_prefix+'fields_section">\n'+'                            </div>\n'+'\n'+'                            <div class="col-xs-12">\n'+'                                <div class="'+form_obj_prefix+'division">\n'+'                                    <button type="submit" class="'+form_obj_prefix+'btn_submit">'+objThis.settings.text_vars.send_button_text+'</button>\n'+'                                </div>\n'+'                            </div>\n'+'                        </div>\n'+'\n'+'                        <div class="row '+form_obj_prefix+'agreements">\n'+'                            <div class="col-xs-12 '+form_obj_prefix+'agreements_section">\n'+'                            </div>\n'+'                        </div>\n'+'                    </div>\n'+'                </form>\n'+'            </div>\n'+'\n'+'            <div class="'+form_obj_prefix+'footer_section">\n'+'\n'+'            </div>\n'+'        </div>\n'+'    </div>'+'</div>';return $popupBody},initPopup:function(){var objThis=this;var $popupBody=$(objThis.initPopup_generate_popup_body());objThis.popup.obj=$popupBody.appendTo($(objThis.element));objThis.popup.form=objThis.popup.obj.find('form');objThis.popup.body=objThis.popup.obj.find('.'+form_obj_prefix+'body_section');objThis.popup.footer=objThis.popup.obj.find('.'+form_obj_prefix+'footer_section');objThis.initPopup_generate_fields($popupBody);objThis.initPopup_generate_popup_agreements($popupBody);objThis.popupAppendEventListeners();objThis.popupApplyMisc()},popupAppendEventListeners:function(){var objThis=this;objThis.popup.form.find('.checkmark').on('click',function(e){e.preventDefault();var input=$(this).siblings('input');var is_checked=input.prop('checked');input.prop('checked',!is_checked).trigger('change',[])});objThis.popup.form.find('.'+form_obj_prefix+'readmore').on('click',function(e){e.preventDefault();objThis.showReadmore(this)});objThis.popup.obj.find('.'+form_obj_prefix+'btn_close').on('click',function(e){e.preventDefault();objThis.HidePopup()});for(var i=0;i<objThis.settings.input.fields.length;i++){var field=objThis.settings.input.fields[i];field.obj.data('index',i);field.obj.on('input',function(e){var index=$(this).data('index');var validated=objThis.ValidateForm([objThis.settings.input.fields[index]],{append_status:!1,focus_first_wrong:!1});if(validated){console.log('validation successful')}
            return!1})}
            for(var i=0;i<objThis.settings.input.agreements.length;i++){var agreement=objThis.settings.input.agreements[i];agreement.obj.data('index',i);agreement.obj.on('change',function(e,_no_check_all_status){var index=$(this).data('index');var validated=objThis.ValidateForm([objThis.settings.input.agreements[index]],{append_status:!1,focus_first_wrong:!1});if(validated){console.log('validation successful')}
                if(!_no_check_all_status){objThis.input_checkbox_check_all_status()}
                return!1})}
            if(objThis.settings.appearance.show_check_all_agreements){objThis.settings.input.check_all_agreements.obj.on('change',function(e,_no_check_all_status){if(!_no_check_all_status){var is_checked=$(this).prop('checked');for(var i=0;i<objThis.settings.input.agreements.length;i++){objThis.settings.input.agreements[i].obj.prop('checked',is_checked).trigger('change',[!0])}}})}
            objThis.input_checkbox_check_all_status();objThis.popup.obj.on('submit',function(e){var status=objThis.SendData({callback:{success:{function:objThis.SendDataReturn,this:objThis,parameters:[{reset_input:!0,message:objThis.settings.text_vars.status_success,style:'success'}]},error:{function:objThis.SendDataReturn,this:objThis,parameters:[{reset_input:!1,message:objThis.settings.text_vars.status_error,style:'error'}]}}});console.log('Submit form status: '+status.success+', '+status.message);return!1})},showReadmore:function(obj){var $this=$(obj);$this.closest('.'+form_obj_prefix+'division').find('.'+form_obj_prefix+'readmore_body').slideToggle()},hideReadmore_all:function(){this.popup.form.find('.agreements input[type="checkbox"]').prop('checked',!1)},popupApplyMisc:function(){var inputs=this.popup.form.find(input_all_mask);console.log('js input mask: '+(typeof $.fn.inputmask!=='undefined'));if(typeof $.fn.inputmask!=='undefined'){var input_masked_items=inputs.filter('input[type="tel"], .jsm_phone');var phones_mask=["###-###-###","## ###-##-##"];console.log('js input mask || masked items: ');console.log(input_masked_items);input_masked_items.inputmask({mask:phones_mask,greedy:!1,definitions:{'#':{validator:"[0-9]",cardinality:1}}})}},input_checkbox_check_all_status:function(){if(this.settings.appearance.show_check_all_agreements){var all_checked=!0;for(var i=0;i<this.settings.input.agreements.length;i++){if(!this.settings.input.agreements[i].obj.prop('checked')){all_checked=!1}}
            this.settings.input.check_all_agreements.obj.prop('checked',all_checked).trigger('change',[!0])}},SendData:function(options){var status={success:!1,message:'SendData: Error (Default)'};var defaults={url:this.settings.api.url,api_custom:this.settings.api.custom,data:this.popup.form.serialize(),data_dictionary:this.settings.input.data_dictionary,type:this.settings.data.form_method,success_param:this.settings.api.param.success,return_param:this.settings.api.param.message,status_sending_text:this.settings.text_vars.status_sending,send_headers:this.settings.data.send_headers};var settings=$.extend(!0,{},defaults,options);this.StatusClear();var validated_fields=this.ValidateForm(this.settings.input.fields);var validated_agreements=this.ValidateForm(this.settings.input.agreements);var validated=validated_fields&&validated_agreements;if(validated){console.log('Validation successful');console.log('Attempting to send data...');this.StatusClear();this.StatusAdd(settings.status_sending_text,{});console.log(this.settings.api.custom);settings.api_custom=$.merge(settings.api_custom,this.URLGetUTMs(this.settings.data.utm_params_dictionary));console.log(settings.api_custom);status=this.SendDataAjax(settings)}else{status={success:!1,message:'SendData: Error (Validation)'}}
            return status},SendDataAjax:function(options){var status={success:!1,message:'SendDataAjax: Error (Default)'};var objThis=this;var defaults={url:'/',type:'POST',api_custom:[],data:'',data_dictionary:{},success_param:{name:'result',value:'success'},return_param:'message',send_headers:!0,};var settings=$.extend(!0,{},defaults,options);if(settings.api_custom){var api_custom_length=settings.api_custom.length;var custom_data_string='';if(settings.data.length>0){custom_data_string+='&'}
            ...
            console.log(settings);if(objThis.settings.status.ajax_processing){status={success:!1,message:'SendDataAjax: Error (Processing...)'}}else{objThis.settings.status.ajax_processing=!0;status={success:!0,message:'SendDataAjax: Success (Got into ajax)'};if(settings.send_headers){$.ajaxSetup({headers:{'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','X-Requested-With':'XMLHttpRequest'}})}
                $.ajax({url:settings.url,type:settings.type,data:settings.data,enctype:'multipart/form-data',dataType:'json',processData:!1,success:function(data){var response_success=!1;var return_message;console.log(data);if(data[settings.return_param]){if($.isArray(data[settings.return_param])||(data[settings.return_param]!==null&&typeof data[settings.return_param]==='object')){for(var index in data[settings.return_param]){console.log(data[settings.return_param][index])}}
            ...
            return is_valid},SendDataReturn:function(options){var defaults={reset_input:!0,message:'',style:'',};var settings=$.extend({},defaults,options);if(settings.reset_input){this.ResetInput({clear_status_only:!0})}
            this.StatusClear();this.StatusAdd(settings.message,{style:settings.style})},ResetInput:function(options){var defaults={clear_status_only:!1,};var settings=$.extend({},defaults,options);var form=this.popup.form;form[0].reset();this.ValidateForm(this.settings.input.fields,{append_status:!1,focus_first_wrong:!1,clear_status_only:settings.clear_status_only});this.ValidateForm(this.settings.input.agreements,{append_status:!1,focus_first_wrong:!1,clear_status_only:settings.clear_status_only})},formatData:function(input){var _input=input;var input_length=_input.length;var output='';if(_input){output+=' ';if(input.constructor===Array){for(var i=0;i<input_length;i++){output+='data-'+_input[i][0]+'='+_input[i][1]+' '}
            ...
            var request={};var qIndex=url.indexOf('?');if(qIndex===-1){return undefined}
            var pairs=url.substring(qIndex+1).split('&');for(var i=0;i<pairs.length;i++){if(!pairs[i])
                continue;var pair=pairs[i].split('=');request[decodeURIComponent(pair[0])]=decodeURIComponent(pair[1])}
            return request},URLGetUTMs:function(utm_params_dictionary){var url_params=this.URLGetParams();var utm_params=[];for(var key in url_params){if(url_params.hasOwnProperty(key)&&(utm_params_dictionary.indexOf(key)>-1)){utm_params.push({name:key,value:url_params[key]})}}
            return utm_params},objSortByPositionInDOM:function(input,attr,attr2){var _input=input;var output;if(attr&&attr2){output=_input.sort(function(a,b){if(a[attr][attr2][0]===b[attr][attr2][0])return 0;if(!a[attr][attr2][0].compareDocumentPosition){return a[attr][attr2][0].sourceIndex-b[attr][attr2][0].sourceIndex}
