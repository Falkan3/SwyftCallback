(function(jQuery,window,document,undefined){"use strict";const pluginName="swyftCallback",pluginNameLower=pluginName.toLowerCase(),formObjPrefix='sc_',formFieldsPrefix=formObjPrefix+'fld_',inputAllMask='input, select, textarea',defaults={api:{url:'test',custom:[{name:'api_key',value:''},],param:{success:{name:'result',value:'success'},message:'',},},data:{form_method:"post",send_headers:!0,custom_button_data:"",custom_popup_data:"",add_utm_params:!1,utm_params_dictionary:['utm_source','utm_medium','utm_campaign','utm_term','utm_content','keypartner'],},appearance:{custom_button_class:"",custom_button_container_class:"",custom_popup_class:"",show_check_all_agreements:!0,overflown_overlay:!0,ripple_effect:1,show_toggle_button_text:!1,},status:{popup_hidden:!0,popup_body_collapsed:!1,button_disabled:!1,ajax_processing:!1,response_from_api_visible:!0,},text_vars:{popup_title:"Contact form",popup_body:"Leave us your phone number. We'll call you back.",send_button_text:"Send",wrong_input_text:"Wrong input",status_success:"Form sent successfuly",status_sending:"Sending form...",status_error:"Server encountered an error",toggle_button_text:!1,},novalidate:!0,input:{prefix:formObjPrefix,fields:[],agreements:[],check_all_agreements:{obj:null,short:'Check all agreements',},regex_table:{inputmask:{phone:["###-###-###","## ###-##-##","(###)###-####"]},'phone':/(\(?(\+|00)?48\)?([ -]?))?(\d{3}[ -]?\d{3}[ -]?\d{3})|([ -]?\d{2}[ -]?\d{3}[ -]?\d{2}[ -]?\d{2})/,'email':/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,'name':/^[a-zA-Z\u00E0\u00E1\u00E2\u00E4\u00E3\u00E5\u0105\u010D\u0107\u0119\u00E8\u00E9\u00EA\u00EB\u0117\u012F\u00EC\u00ED\u00EE\u00EF\u0142\u0144\u00F2\u00F3\u00F4\u00F6\u00F5\u00F8\u00F9\u00FA\u00FB\u00FC\u0173\u016B\u00FF\u00FD\u017C\u017A\u00F1\u00E7\u010D\u015B\u0161\u015B\u017E\u00C0\u00C1\u00C2\u00C4\u00C3\u00C5\u0104\u0106\u010C\u0116\u0118\u00C8\u00C9\u00CA\u00CB\u00CC\u00CD\u00CE\u00CF\u012E\u0141\u0143\u00D2\u00D3\u00D4\u00D6\u00D5\u00D8\u00D9\u00DA\u00DB\u00DC\u0172\u016A\u0178\u00DD\u017B\u0179\u00D1\u00DF\u00C7\u0152\u00C6\u010C\u015A\u0160\u015A\u017D\u2202\u00F0 ,.'-]+$/,},data_dictionary:{}},body_content:[],templates:{input:{field:{obj:null,name:'phone',field_name:formObjPrefix+'telephone',label:'Phone number',type:'tel',data_field_type:'phone',placeholder:'000-000-000',max_length:20,required:!0},agreement:{obj:null,field_name:formObjPrefix+'agreement',type:'checkbox',short:'Lorem',long:'Ipsum',readmore:'More',readless:'Less',required:!0,checked:!0,},},body_content:{short:'Short',long:'Long',readmore:'More',readless:'Less',}},callbacks:{onShow:null,onHide:null,onSend:{success:{function:null,this:this,parameters:null,},error:{function:null,this:this,parameters:null,}}}};function Plugin(element,options){this.element=element;this.$element=jQuery(element);this.settings=jQuery.extend(!0,{},defaults,options);this._defaults=defaults;this._name=pluginName;this._nameLower=pluginNameLower;this._objPrefix=formObjPrefix;this._methods=methods;this._inputAllMask=inputAllMask;this._methods.setDefaultVars(this);this.html=jQuery('html');this.button={obj:null};this.popup={obj:null,form:null,body:null,body_content:null,footer:null};this._methods.init(this)}
    const methods={init:function(instance){instance._methods.initPopup(instance);instance._methods.initButton(instance)},setDefaultVars:function(instance){if(instance.settings.input.fields){const template=instance.settings.templates.input.field;for(let i=0;i<instance.settings.input.fields.length;i++){instance.settings.input.fields[i]=jQuery.extend({},template,instance.settings.input.fields[i])}}
            if(instance.settings.input.agreements){const template=instance.settings.templates.input.agreement;for(let i=0;i<instance.settings.input.agreements.length;i++){instance.settings.input.agreements[i]=jQuery.extend({},template,instance.settings.input.agreements[i])}}
            if(instance.settings.body_content){const template=instance.settings.templates.body_content;for(let i=0;i<instance.settings.body_content.length;i++){instance.settings.body_content[i]=jQuery.extend({},template,instance.settings.body_content[i])}}},formatClasses:function(input){const _input=input;const input_length=_input.length;let output='';if(input){output+=' ';if(input.constructor===Array){for(let i=0;i<input_length;i++){output+=_input[i]+' '}
            if(output[output.length-1]===' '){output=output.slice(0,-1)}}else{output+=_input}}
            return output},initButton:function(instance){instance._methods.initButtonBody(instance);instance._methods.buttonAppendEventListeners(instance)},initButtonBody:function(instance){const buttonClasses=instance._methods.formatClasses(instance.settings.appearance.custom_button_class);const data=instance._methods.formatData(instance.settings.data.custom_button_data);let rippleClass='';switch(instance.settings.appearance.ripple_effect){case 2:rippleClass='ripple2';break;default:rippleClass='ripple';break}
            ...
            for(let i=0;i<instance.settings.input.agreements.length;i++){const agreement=instance.settings.input.agreements[i];let dynamic_attributes=[];dynamic_attributes=[{name:agreement.field_name,attributes:[{key:'id',value:agreement.field_name},{key:'name',value:agreement.field_name},{key:'type',value:'checkbox'},{key:'value',value:'true'},{key:'data-field-type',value:'checkbox'},],formatted:''},];if(agreement.checked){dynamic_attributes[0].attributes.push({key:'checked',value:'checked'})}
                ...
                agreements+=output;$obj=jQuery(output).appendTo(agreements_section);instance.settings.input.agreements[i].obj=$obj.find(instance._inputAllMask).first()}}
            ...
            console.log(settings);if(instance.settings.status.ajax_processing){status={success:!1,message:'SendDataAjax: Error (Processing...)'}}else{instance.settings.status.ajax_processing=!0;status={success:!0,message:'SendDataAjax: Success (Got into ajax)'};if(settings.send_headers){jQuery.ajaxSetup({headers:{'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','X-Requested-With':'XMLHttpRequest'}})}
                jQuery.ajax({url:settings.url,type:settings.type,data:settings.data,enctype:'multipart/form-data',dataType:'json',processData:!1,success:function(data){let response_success=!1;let return_message;console.log(data);if(data[settings.return_param]){if(jQuery.isArray(data[settings.return_param])||(data[settings.return_param]!==null&&typeof data[settings.return_param]==='object')){for(let index in data[settings.return_param]){console.log(data[settings.return_param][index])}}
                        console.log('API status: '+data.status);console.log('API message: ');console.log(data[settings.return_param])}
                        if(jQuery.isArray(data[settings.return_param])){return_message=data[settings.return_param].join(', ')}else{return_message=data[settings.return_param]}
                        ...
                        if(response_success){if(settings.callback.success.function&&jQuery.isFunction(settings.callback.success.function)){settings.callback.success.function.apply(settings.callback.success.this,settings.callback.success.parameters)}
                            if(instance.settings.callbacks.onSend.success.function&&jQuery.isFunction(instance.settings.callbacks.onSend.success.function)){instance.settings.callbacks.onSend.success.function.apply(instance.settings.callbacks.onSend.success.this,[jQuery.extend(!0,{},data,instance.settings.callbacks.onSend.success.parameters)])}}else{if(settings.callback.error.function&&jQuery.isFunction(settings.callback.error.function)){settings.callback.error.function.apply(settings.callback.error.this,settings.callback.error.parameters)}
                            if(instance.settings.callbacks.onSend.error.function&&jQuery.isFunction(instance.settings.callbacks.onSend.error.function)){instance.settings.callbacks.onSend.error.function.apply(instance.settings.callbacks.onSend.error.this,[jQuery.extend(!0,{},data,instance.settings.callbacks.onSend.error.parameters)])}
            ...
            return{is_valid:is_valid,field:field}},ValidateForm:function(instance,_fields,options){const defaults={append_status:!0,focus_first_wrong:!0,fade_duration:300,clear_status_only:!1};const settings=jQuery.extend({},defaults,options);const fields=_fields;let is_valid=!0;let wrong_inputs=[];for(let i=0;i<fields.length;i++){const field=fields[i];const field_valid=instance._methods.ValidateField(instance,field);const $this=field.obj;const $this_container=$this.closest('.input');const old_obj=$this_container.find('.'+instance._objPrefix+'status');if(settings.append_status){old_obj.remove()}else{old_obj.fadeOut(settings.fade_duration,function(){old_obj.remove()})}
            if(settings.clear_status_only){$this.removeClass('correct-input');$this_container.removeClass('correct-input');$this.removeClass('wrong-input');$this_container.removeClass('wrong-input')}else{if(field_valid.is_valid){$this.removeClass('wrong-input');$this_container.removeClass('wrong-input');$this.addClass('correct-input');$this_container.addClass('correct-input')}else{$this.removeClass('correct-input');$this_container.removeClass('correct-input');$this.addClass('wrong-input');$this_container.addClass('wrong-input');wrong_inputs.push({field:field,message:''});if(settings.append_status){const $wrong_input_obj=jQuery('<span class="'+instance._objPrefix+'status"></span>');$wrong_input_obj.text(instance.settings.text_vars.wrong_input_text);$wrong_input_obj.hide();$wrong_input_obj.appendTo($this_container);$wrong_input_obj.fadeIn(settings.fade_duration)}
                is_valid=!1}}}
            ...
            return-1})}
            return output},};jQuery.fn[pluginName]=function(options){let instances=[];this.each(function(){if(!jQuery.data(this,"plugin_"+pluginName)){const instance=new Plugin(this,options);jQuery.data(this,"plugin_"+pluginName,instance);instances.push(instance)}
